...
7. [Claude 첫날 안전 루프](/claude-code/claude-safe-first-day-loop) — 입문 안전 루프
8. [Claude 중형 리팩토링 플레이북](/claude-code/claude-mid-size-refactor-playbook) — 중급 레인 운영
9. [Claude 고위험 변경 거버넌스](/claude-code/claude-high-risk-change-governance) — 고급 릴리스 통제
10. [Claude 운영 매뉴얼](/claude-code/claude-operating-manual) — 팀 단위 운영 리듬

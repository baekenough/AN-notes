...
> **공식 레퍼런스**: [Sub-agents](https://geminicli.com/docs/core/subagents/) · [Skills](https://geminicli.com/docs/core/skills/) · [Tools](https://geminicli.com/docs/tools/) · [Extensions 개요](https://geminicli.com/docs/extensions/)
...
- **skills 발견 계층, 활성화, 작성 원리** — [Skills](https://geminicli.com/docs/core/skills/)

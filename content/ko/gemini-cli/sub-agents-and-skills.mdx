...
4. **서브 에이전트와 스킬 오케스트레이션** — 위임과 전문가 워크플로 ← **현재 문서**
5. [Multi-Agent Orchestration](./gemini-multi-agent-orchestration) — 전문가 팀 조율하기
6. [Gemini GitHub Actions](./gemini-github-actions) — CI 자동화와 리뷰
7. [Gemini CLI Headless Automation](./headless-automation) — 스크립트, CI, 구조화 출력
...
- 복잡한 팀 워크플로 설계는 [Multi-Agent Orchestration](/gemini-cli/gemini-multi-agent-orchestration)
- CI 환경에서의 자동화 리뷰는 [Gemini GitHub Actions](/gemini-cli/gemini-github-actions)

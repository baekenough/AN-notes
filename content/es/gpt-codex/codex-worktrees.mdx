...
10. [Handoffs en Codex](./codex-handoffs) — convertir resultados de lanes en entregables mergeables
...
Cuando un equipo supera 3–4 worktrees simultáneos, el naming ad-hoc deja de ser legible.
Conviene fijar una matriz corta:
...
Muchos fallos de paralelización vienen de handoffs inconsistentes, no de código difícil.
Define un contrato mínimo para cada entrega entre lanes:

...
6. [MCP en Codex](./codex-mcp) — conectar contexto externo
7. [Reviews y Automatizaciones con Codex](./codex-ci-cd-workflows) — review, worktrees y ejecuciones unattended

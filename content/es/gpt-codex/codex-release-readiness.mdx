...
13. [Codex Loop Seguro del Primer Día](./codex-safe-first-day-loop) — reinicio onboarding para principiantes
14. [Playbook de Entrega de Equipo en Codex](./codex-team-delivery-playbook) — ritmo intermedio por lanes
15. [Gobernanza de Cambios de Alto Riesgo en Codex](./codex-high-risk-change-governance) — control avanzado para releases críticas
16. [Manual Operativo de Codex](./codex-operating-manual) — ritmo operativo de equipo

...
11. [Loops de Verificación en Codex](./codex-verification-loops) — convertir claims de handoff en evidencia
...
Luego continúa con [Loops de Verificación en Codex](./codex-verification-loops) para estandarizar la calidad de prueba antes del merge.

...
> **Referencias oficiales**: [Sub-agents](https://geminicli.com/docs/core/subagents/) · [Skills](https://geminicli.com/docs/core/skills/) · [Tools](https://geminicli.com/docs/tools/) · [Extensions overview](https://geminicli.com/docs/extensions/)
...
- **Capas de descubrimiento y activación de skills** — [Skills](https://geminicli.com/docs/core/skills/)

...
7. [Claude Loop Seguro del Primer Día](/claude-code/claude-safe-first-day-loop) — onboarding seguro para principiantes
8. [Playbook Claude para Refactor de Tamaño Medio](/claude-code/claude-mid-size-refactor-playbook) — disciplina intermedia por lanes
9. [Gobernanza de Cambios de Alto Riesgo con Claude](/claude-code/claude-high-risk-change-governance) — control avanzado de release
10. [Manual Operativo de Claude](/claude-code/claude-operating-manual) — ritmo operativo a escala de equipo

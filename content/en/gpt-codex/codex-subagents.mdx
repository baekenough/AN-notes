...
9. [Codex Worktrees](./codex-worktrees) — isolate long parallel execution safely
...
If you want dedicated naming, lifecycle, and cleanup patterns, continue to [Codex Worktrees](./codex-worktrees).

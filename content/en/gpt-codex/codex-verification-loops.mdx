...
12. [Codex Release Readiness](./codex-release-readiness) — run final go/no-go gates before production
...
Then use [Codex Release Readiness](./codex-release-readiness) to make the final production decision explicit.
